    ...
    <div class="container-xl">
      <div class="row gy-4">
        <div class="col-lg-8">
                ...
                <div class="post">
                  <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/editor-lg.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                  ...
                  <ul class="meta list-inline mt-4 mb-0">
                    <li class="list-inline-item">
                      <a href="#"
                        ><img
                          src="@/assets/images/other/author-sm.png"
                          class="author"
                          alt="author"
                        />Katen Doe</a
                      >
                ...
                <div class="post post-list-sm square">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/editor-sm-1.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/editor-sm-2.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/editor-sm-3.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/editor-sm-4.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post">
                  <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-lg-1.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square before-seperator">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-sm-1.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square before-seperator">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-sm-2.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post">
                  <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-lg-2.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square before-seperator">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-sm-3.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm square before-seperator">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/trending-sm-4.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
          ...
          <swiper
            class="swiper post-carousel-twoCol post-carousel"
            :loop="true"
            :slides-per-view="2"
          >
              ...
              <div class="post post-over-content">
                ...
                <a href="blog-single.html">
                  <div class="thumb rounded">
                    <div class="inner">
                      <img
                        src="@/assets/images/posts/inspiration-1.jpg"
                        alt="thumb"
                      />
                    </div>
                  </div>
                ...
                <div class="post post-list clearfix">
                  <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/latest-sm-1.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                  ...
                  <div class="details">
                    ...
                    <h5 class="post-title">
                      <a href="blog-single.html"
                        >The Next 60 Things To Immediately Do About Building</a
                      >
                    </h5>
                    <p class="excerpt mb-0">
                ...
                <div class="post post-list clearfix">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/latest-sm-2.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list clearfix">
                  <div class="thumb rounded">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/latest-sm-3.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list clearfix">
                  <div class="thumb rounded">
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/latest-sm-4.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm circle">
                  <div class="thumb circle">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/tabs-1.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm circle">
                  <div class="thumb circle">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/tabs-2.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                ...
                <div class="post post-list-sm circle">
                  <div class="thumb circle">
                    ...
                    <a href="blog-single.html">
                      <div class="inner">
                        <img
                          src="@/assets/images/posts/tabs-3.jpg"
                          alt="post-title"
                        />
                      </div>
                    </a>
                  ...
                  <div class="post post-carousel">
                    <div class="thumb rounded">
                      ...
                      <a href="blog-single.html">
                        <div class="inner">
                          <img
                            src="@/assets/images/widgets/widget-carousel-1.jpg"
                            alt="post-title"
                          />
                        </div>
                      </a>
                  ...
                  <div class="post post-carousel">
                    <div class="thumb rounded">
                      ...
                      <a href="blog-single.html">
                        <div class="inner">
                          <img
                            src="@/assets/images/widgets/widget-carousel-2.jpg"
                            alt="post-title"
                          />
                        </div>
                      </a>
