        ...
        <div class="col-lg-8">
          ...
          <div class="post post-single">
            ...
            <div class="featured-image">
              <img
                src="@/assets/images/posts/featured-lg.jpg"
                alt="post-title"
              />
            </div>
            <!-- post content -->
            <div class="post-content clearfix">
              <p>
                ...
                Europe uses the same <a href="#">vocabulary</a>. The languages
              ...
              <p>
                ...
                it <mark>would be</mark> necessary to have uniform grammar,
                pronunciation and more common words.
              </p>

              <figure class="figure">
                <img
                  src="@/assets/images/posts/post-lg-2.jpg"
              ...
              <img
                src="@/assets/images/posts/single-sm-1.jpg"
              ...
              <p>
                ...
                regular than the existing <a href="#">European languages</a>. It
              ...
              <p>
                ...
                <a href="#">English</a>, as a skeptical Cambridge friend of mine
                told me what Occidental is. The European languages are members
                of the same family. Their separate existence is a myth. For
          ...
          <div class="about-author padding-30 rounded">
            <div class="thumb">
              <img
                src="@/assets/images/other/avatar-about.png"
                alt="Katen Doe"
              />
            </div>
            <div class="details">
          ...
          <div class="comments bordered padding-30 rounded">
            <ul class="comments">
              ...
              <li class="comment rounded">
                <div class="thumb">
                  <img
                    src="@/assets/images/other/comment-1.png"
                    alt="John Doe"
                  />
                </div>
                <div class="details">
                  ...
                  <p>
                    ...
                    Etiam vitae odio ut tortor fringilla cursus sed quis odio.
                  </p>
              ...
              <li class="comment child rounded">
                <div class="thumb">
                  <img
                    src="@/assets/images/other/comment-2.png"
                    alt="John Doe"
                  />
                </div>
                <div class="details">
              ...
              <li class="comment rounded">
                <div class="thumb">
                  <img
                    src="@/assets/images/other/comment-3.png"
                    alt="John Doe"
                  />
                </div>
                <div class="details">
